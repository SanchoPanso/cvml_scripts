...
def main():
    ...
    orig_dataset_dir = r'D:\datasets\geo_ai\geoai_360\geoai_360_13062023'
    cropped_dataset_dir = r'D:\datasets\geo_ai\geoai_360\geoai_360_13062023_cropped_1280'
    splitted_dataset_dir = r'D:\datasets\geo_ai\geoai_360\geoai_360_13062023_splitted'

    # create_yolo_labels(orig_dataset_dir)
    create_cropped_dataset(orig_dataset_dir, cropped_dataset_dir, (1280, 1280))
            ...
            for row in range(num_of_rows):
                for col in range(num_of_cols):
                    ...
                    for bbox in bboxes:
                        ...
                        # if img_name == 'pano_000017_000006' and crop_cnt == 9:
