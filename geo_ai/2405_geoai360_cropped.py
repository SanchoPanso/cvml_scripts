...
def main():
    ...
    orig_dataset_dir = r'/mnt/data/geo_ai_datasets/geoai360/geoai_360_24052023'
    cropped_dataset_dir = r'/mnt/data/geo_ai_datasets/geoai360/geoai_360_24052023_cropped_1280'
    splitted_dataset_dir = r'/mnt/data/geo_ai_datasets/geoai360/geoai_360_24052023_splitted'
...
def create_cropped_dataset(src_dir: str, dst_dir: str, imgsz: tuple = (1280, 1280)):
    ...
    for split in ['train']:
        ...
        src_annotations_path = os.path.join(src_annotations_dir, f'{split}.json')
        ...
        src_annot = cvml.read_coco(src_annotations_path)
        dst_annot = cvml.Annotation(classes, {})
            ...
            for row in range(num_of_rows):
                for col in range(num_of_cols):
                    ...
                    for bbox in bboxes:
                        ...
                        contour = np.array([x_points, y_points]).astype('float32').T
