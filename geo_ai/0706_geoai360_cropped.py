...
def main():
    ...
    orig_dataset_dir = r'/mnt/data/geo_ai_datasets/geoai360/geoai_360_07062023'
    cropped_dataset_dir = r'/mnt/data/geo_ai_datasets/geoai360/geoai_360_07062023_cropped_2000'
    splitted_dataset_dir = r'/mnt/data/geo_ai_datasets/geoai360/geoai_360_07062023_splitted'

    # create_yolo_labels(orig_dataset_dir)
    create_cropped_dataset(orig_dataset_dir, cropped_dataset_dir, (2000, 2000))
