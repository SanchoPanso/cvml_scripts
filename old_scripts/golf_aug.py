...
class GOLF_Albumentations:
    def __init__(self):
        self.dir_coco_obj = r"E:\PythonProjects\AnnotationConverter\datasets\defects_segment_17092022"
        self.coco_class_names = ['comet']
        self.class_names = ['comet', 'joint']
...
def get_tube_crop(detector: Yolov5Detector, img: np.ndarray) -> np.ndarray:
    ...
    for i in range(output.shape[0]):
        ...
        if cls_conf > 0.5 and w * h > 1000000:
            print(w, h)
...
if __name__ == '__main__':
    ...
    new_dataset_dir = r'F:\datasets\tmk_yolov5_17092022_aug3'
    ...
    for split in splits:
        ...
        for img_file in img_files:
            ...
            cv2.imwrite(os.path.join(new_images_dir, img_name + '_aug3.jpg'), new_img)
            write_labels(os.path.join(new_labels_dir, img_name + '_aug3.txt'), new_labels)
