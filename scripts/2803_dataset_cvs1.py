...
def main():
    save_dir = '/home/student2/datasets/prepared/tmk_cvs1_yolo_640px_28032023' 
    
    raw_datasets_dir = '/home/student2/datasets/raw/CVS1'
    raw_dirs = set()
    raw_dirs |= set(glob.glob(os.path.join(raw_datasets_dir, '*'))) 
    raw_dirs -= set(glob.glob(os.path.join(raw_datasets_dir, 'number_January1'))) 
