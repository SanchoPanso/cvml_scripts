...
def main():
    save_dir = '/home/student2/datasets/prepared/tmk_cvs1_yolo_640px_05032023'
    base_dataset = '/home/student2/datasets/prepared/tmk_cvs1_yolo_640px_01032023' 
    
    raw_datasets_dir = '/home/student2/datasets/raw'
    raw_dirs = set()
    raw_dirs |= set(glob.glob(os.path.join(raw_datasets_dir, 'cvs1_number_February1'))) 
