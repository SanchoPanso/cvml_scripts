...
def main():
    ...
    raw_dirs |= set(glob.glob(os.path.join(raw_datasets_dir, 'TMK_false_defects_february_2')))

    raw_dirs = list(raw_dirs)
    raw_dirs.sort()
    
    save_dir = '/home/student2/datasets/prepared/tmk_cvs1_yolo_640px_20022023'
